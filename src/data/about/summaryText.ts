export const summaryTextEn = `Focused on Red Teaming and DevOps, with a strong background as a Blockchain Developer and Python developer. I build tools to interact with smart contracts, automate workflows, and manage large-scale Web3 infrastructures.
